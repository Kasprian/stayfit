    ...
    void onSearchButton(ActionEvent event) {
        ...
        try {
            ...
            if (datePicker.getValue() == null && !GroupRadioButton.isSelected() && !GoodRadioButton.isSelected() && !ExerciseRadioButton.isSelected()) {
                ...
                sql = "select SUM(id),sources,commitDate,SUM(calories),SUM(carbohydrate),SUM(protein),SUM(fats) from Calories_and_nutrients_balance GROUP BY commitDate";
            } else if (datePicker.getValue() != null && !GroupRadioButton.isSelected() && !GoodRadioButton.isSelected() && !ExerciseRadioButton.isSelected()) {
                sql = "select * from Calories_and_nutrients_balance WHERE commitDate='" + datePicker.getValue() + "'";
            } else if (datePicker.getValue() == null && !GroupRadioButton.isSelected() && GoodRadioButton.isSelected() && !ExerciseRadioButton.isSelected()) {
                sql = "select * from Calories_and_nutrients_balance WHERE sources='F'";
            } else if (datePicker.getValue() == null && !GroupRadioButton.isSelected() && !GoodRadioButton.isSelected() && ExerciseRadioButton.isSelected()) {
                sql = "select * from Calories_and_nutrients_balance WHERE sources='E'";
            } else if (datePicker.getValue() == null && GroupRadioButton.isSelected() && GoodRadioButton.isSelected() && !ExerciseRadioButton.isSelected()) {
                sql = "select id,sources,commitDate,SUM(calories),SUM(carbohydrate),SUM(protein),SUM(fats) from Calories_and_nutrients_balance WHERE sources='F' GROUP BY sources ";
            } else if (datePicker.getValue() == null && GroupRadioButton.isSelected() && !GoodRadioButton.isSelected() && ExerciseRadioButton.isSelected()) {
                sql = "select id,sources,commitDate,SUM(calories),SUM(carbohydrate),SUM(protein),SUM(fats) from Calories_and_nutrients_balance WHERE sources='E' GROUP BY sources ";
            } else if (datePicker.getValue() != null && !GroupRadioButton.isSelected() && GoodRadioButton.isSelected() && !ExerciseRadioButton.isSelected()) {
                sql = "select * from Calories_and_nutrients_balance WHERE commitDate='" + datePicker.getValue() + "'AND sources='F'";
            } else if (datePicker.getValue() != null && !GroupRadioButton.isSelected() && !GoodRadioButton.isSelected() && ExerciseRadioButton.isSelected()) {
                sql = "select * from Calories_and_nutrients_balance WHERE commitDate='" + datePicker.getValue() + "'AND sources='E'";
            } else if (datePicker.getValue() != null && GroupRadioButton.isSelected() && GoodRadioButton.isSelected() && !ExerciseRadioButton.isSelected()) {
                sql = "select id,sources,commitDate,SUM(calories),SUM(carbohydrate),SUM(protein),SUM(fats) from Calories_and_nutrients_balance WHERE sources='F' AND commitDate='" + datePicker.getValue() + "'GROUP BY sources,commitDate ";
            } else if (datePicker.getValue() != null && GroupRadioButton.isSelected() && !GoodRadioButton.isSelected() && ExerciseRadioButton.isSelected()) {
                sql = "select id,sources,commitDate,SUM(calories),SUM(carbohydrate),SUM(protein),SUM(fats) from Calories_and_nutrients_balance WHERE sources='E' AND commitDate='" + datePicker.getValue() + "'GROUP BY sources,commitDate ";
            }else if(datePicker.getValue() != null && GroupRadioButton.isSelected() && !GoodRadioButton.isSelected() && !ExerciseRadioButton.isSelected()){
                sql = "select id,sources,commitDate,SUM(calories),SUM(carbohydrate),SUM(protein),SUM(fats) from Calories_and_nutrients_balance WHERE +commitDate='" + datePicker.getValue()+"'  GROUP BY commitDate ";
            }else if(datePicker.getValue() != null && GroupRadioButton.isSelected() && GoodRadioButton.isSelected() && ExerciseRadioButton.isSelected()){
                sql = "select id,sources,commitDate,SUM(calories),SUM(carbohydrate),SUM(protein),SUM(fats) from Calories_and_nutrients_balance WHERE +commitDate='" + datePicker.getValue()+"'  GROUP BY commitDate,sources ";
            }
            try {
